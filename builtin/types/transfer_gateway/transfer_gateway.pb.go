...
// source: github.com/diademnetwork/go-diadem/builtin/types/transfer_gateway/transfer_gateway.proto
...
const (
	...
	TransferGatewayTokenKind_diademCOIN     TransferGatewayTokenKind = 4
	TransferGatewayTokenKind_TRX          TransferGatewayTokenKind = 5
	TransferGatewayTokenKind_TRC20        TransferGatewayTokenKind = 6
	TransferGatewayTokenKind_BNBdiademToken TransferGatewayTokenKind = 7
...
type TransferGatewayState struct {
	...
	// Max total ETH or diadem withdrawal amount the gateway will allow in a 24 hour withdrawal period
	...
	// Max per-account ETH or diadem withdrawal amount the gateway will allow in a 24 hour withdrawal period
	...
	// Total amount of ETH or diadem (depending on the Gateway) withdrawn through this gateway within
...
type TransferGatewayPendingWithdrawalSummary struct {
	...
	// Intended to be diadem Amount for Binance dex
...
type TransferGatewayLocalAccount struct {
	...
	// Total amount of ETH or diadem (depending on the Gateway) withdrawn by this account within the
...
type TransferGatewayWithdrawdiademCoinRequest struct {
	// Amount of diademcoin to withdraw
	Amount *types.BigUInt `protobuf:"bytes,1,opt,name=amount" json:"amount,omitempty"`
	// Address of Mainnet diademcoin contract
	TokenContract *types.Address `protobuf:"bytes,2,opt,name=token_contract,json=tokenContract" json:"token_contract,omitempty"`
	// Ethereum address of the account that should receive the diademcoin.
	// If this field is omitted the Gateway will attempt to obtain the recipient address from a
	// previously created mapping between the sender's DAppChain address and their Ethereum address,
	// if no such mapping exists the request will error out.
...
func (m *TransferGatewayWithdrawdiademCoinRequest) Reset() {
	*m = TransferGatewayWithdrawdiademCoinRequest{}
}
func (m *TransferGatewayWithdrawdiademCoinRequest) String() string { return proto.CompactTextString(m) }
func (*TransferGatewayWithdrawdiademCoinRequest) ProtoMessage()    {}
func (*TransferGatewayWithdrawdiademCoinRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_19d5bb437f6510e8, []int{34}
}
func (m *TransferGatewayWithdrawdiademCoinRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TransferGatewayWithdrawdiademCoinRequest.Unmarshal(m, b)
}
func (m *TransferGatewayWithdrawdiademCoinRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TransferGatewayWithdrawdiademCoinRequest.Marshal(b, m, deterministic)
}
func (dst *TransferGatewayWithdrawdiademCoinRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransferGatewayWithdrawdiademCoinRequest.Merge(dst, src)
}
func (m *TransferGatewayWithdrawdiademCoinRequest) XXX_Size() int {
	return xxx_messageInfo_TransferGatewayWithdrawdiademCoinRequest.Size(m)
}
func (m *TransferGatewayWithdrawdiademCoinRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TransferGatewayWithdrawdiademCoinRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TransferGatewayWithdrawdiademCoinRequest proto.InternalMessageInfo

func (m *TransferGatewayWithdrawdiademCoinRequest) GetAmount() *types.BigUInt {
	if m != nil {
		return m.Amount
	}
	return nil
...
func (m *TransferGatewayWithdrawdiademCoinRequest) GetTokenContract() *types.Address {
	if m != nil {
		return m.TokenContract
	}
	return nil
...
func (m *TransferGatewayWithdrawdiademCoinRequest) GetRecipient() *types.Address {
	if m != nil {
		return m.Recipient
	}
	return nil
...
type TransferGatewayWithdrawdiademCoinError struct {
	WithdrawdiademCoinRequest *TransferGatewayWithdrawdiademCoinRequest `protobuf:"bytes,1,opt,name=withdraw_diadem_coin_request,json=withdrawdiademCoinRequest" json:"withdraw_diadem_coin_request,omitempty"`
	ErrorMessage            string                                  `protobuf:"bytes,2,opt,name=error_message,json=errorMessage,proto3" json:"error_message,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                                `json:"-"`
	XXX_unrecognized        []byte                                  `json:"-"`
	XXX_sizecache           int32                                   `json:"-"`
...
func (m *TransferGatewayWithdrawdiademCoinError) Reset()         { *m = TransferGatewayWithdrawdiademCoinError{} }
func (m *TransferGatewayWithdrawdiademCoinError) String() string { return proto.CompactTextString(m) }
func (*TransferGatewayWithdrawdiademCoinError) ProtoMessage()    {}
func (*TransferGatewayWithdrawdiademCoinError) Descriptor() ([]byte, []int) {
	return fileDescriptor_transfer_gateway_19d5bb437f6510e8, []int{46}
}
func (m *TransferGatewayWithdrawdiademCoinError) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TransferGatewayWithdrawdiademCoinError.Unmarshal(m, b)
}
func (m *TransferGatewayWithdrawdiademCoinError) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TransferGatewayWithdrawdiademCoinError.Marshal(b, m, deterministic)
}
func (dst *TransferGatewayWithdrawdiademCoinError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TransferGatewayWithdrawdiademCoinError.Merge(dst, src)
}
func (m *TransferGatewayWithdrawdiademCoinError) XXX_Size() int {
	return xxx_messageInfo_TransferGatewayWithdrawdiademCoinError.Size(m)
}
func (m *TransferGatewayWithdrawdiademCoinError) XXX_DiscardUnknown() {
	xxx_messageInfo_TransferGatewayWithdrawdiademCoinError.DiscardUnknown(m)
}

var xxx_messageInfo_TransferGatewayWithdrawdiademCoinError proto.InternalMessageInfo

func (m *TransferGatewayWithdrawdiademCoinError) GetWithdrawdiademCoinRequest() *TransferGatewayWithdrawdiademCoinRequest {
	if m != nil {
		return m.WithdrawdiademCoinRequest
	}
	return nil
}

func (m *TransferGatewayWithdrawdiademCoinError) GetErrorMessage() string {
	if m != nil {
		return m.ErrorMessage
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*TransferGatewayWithdrawdiademCoinRequest)(nil), "TransferGatewayWithdrawdiademCoinRequest")
	...
	proto.RegisterType((*TransferGatewayWithdrawdiademCoinError)(nil), "TransferGatewayWithdrawdiademCoinError")
...
func init() {
	proto.RegisterFile("github.com/diademnetwork/go-diadem/builtin/types/transfer_gateway/transfer_gateway.proto", fileDescriptor_transfer_gateway_19d5bb437f6510e8)
}
