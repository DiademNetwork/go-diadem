...
// source: github.com/diademnetwork/go-diadem/builtin/types/ethcoin/ethcoin.proto
...
func init() {
	proto.RegisterFile("github.com/diademnetwork/go-diadem/builtin/types/ethcoin/ethcoin.proto", fileDescriptor_ethcoin_15cf8379a9e6a48d)
}
