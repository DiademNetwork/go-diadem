...
// source: github.com/diademnetwork/go-diadem/testdata/test.proto
...
func init() {
	proto.RegisterFile("github.com/diademnetwork/go-diadem/testdata/test.proto", fileDescriptor_test_652711cb7db5e8b4)
}
