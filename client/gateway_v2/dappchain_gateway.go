...
func (tg *DAppChainGateway) AddAuthorizedContractMapping(from common.Address, to diadem.Address, gatewayOwner *client.Identity) error {
...
func (tg *DAppChainGateway) AddContractMapping(from common.Address, to diadem.Address,
...
func (tg *DAppChainGateway) GetContractMapping(identity *client.Identity, from diadem.Address) (*tgtypes.TransferGatewayGetContractMappingResponse, error) {
	req := &tgtypes.TransferGatewayGetContractMappingRequest{
		From: from.MarshalPB(),
	}
	var resp tgtypes.TransferGatewayGetContractMappingResponse
	_, err := tg.contract.StaticCall("GetContractMapping", req, identity.diademAddr, &resp)
	return &resp, err
}
...
func (tg *DAppChainGateway) GetTrustedValidators(identity *client.Identity) (*tgtypes.TransferGatewayTrustedValidators, error) {
	...
	_, err := tg.contract.StaticCall("GetTrustedValidators", req, identity.diademAddr, &resp)
	return resp.TrustedValidators, err
}

func (tg *DAppChainGateway) UpdateTrustedValidators(
	identity *client.Identity, validators []*diadem.Address,
) error {
	...
	_, err := tg.contract.Call("UpdateTrustedValidators", req, identity.diademSigner, nil)
	return err
}
...
func (tg *DAppChainGateway) SubmitHotWalletDepositTxHash(identity *client.Identity, txHash common.Hash) error {
	...
	_, err := tg.contract.Call("SubmitHotWalletDepositTxHash", req, identity.diademSigner, nil)
	return err
}
