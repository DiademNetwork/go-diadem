...
// Parses a serialized signatures array into a list of (v,r,s) triples plus their corresponding validator indexes, in order. Refer to https://github.com/diademnetwork/transfer-gateway-v2/pull/83/files#diff-0aada7672d303fc5bbdeb252dc7ff653R208 for more information.
...
func WithdrawalHash(withdrawer common.Address, tokenAddr common.Address, gatewayAddr common.Address, tokenKind tgtypes.TransferGatewayTokenKind, tokenId *big.Int, amount *big.Int, nonce *big.Int, shouldPrefix bool) []byte {
	...
	case tgtypes.TransferGatewayTokenKind_diademCOIN, tgtypes.TransferGatewayTokenKind_ERC20:
		hash = ssha.SoliditySHA3(
			[]string{"uint256", "address"},
			amount, tokenAddr,
		)
