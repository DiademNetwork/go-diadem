...
func TestSolidityUnpackString(t *testing.T) {
	...
	receipt.diademAddr = "0x989b462ebdda5e6ee4e05dd2884932ef44f920c3"
	receipt.Name = "aaaa"
	receipt.Desc = "mimi"
	receipt.Detail = "deep"
	...
	if strings.ToLower(receipt.diademAddr) != res[2] {
		t.Errorf("convert address failed -\n%s\n%s", receipt.diademAddr, res[2])
	}
...
func TestSolidityUnpackString2(t *testing.T) {
	...
	testObj.diademAddr = "0x989b462ebdda5e6ee4e05dd2884932ef44f920c3"
	testObj.Name = "Amita"
	testObj.Desc = "Mpch"
	...
	if strings.ToLower(testObj.diademAddr) != res[2] {
		t.Errorf("convert address failed -\n%s\n%s", testObj.diademAddr, res[2])
	}
