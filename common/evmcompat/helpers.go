...
// ToEthereumChainID converts a diadem chain ID (string) to an Ethereum chain ID (integer)
func ToEthereumChainID(chainID string) (*big.Int, error) {
	// This is the same way that diademProvider in diadem-js converts the chain ID
