...
// source: github.com/diademnetwork/go-diadem/plugin/types/types.proto
...
import vm "github.com/diademnetwork/go-diadem/vm"
...
type EvmTxReceipt struct {
	...
	LogsBdiadem            []byte         `protobuf:"bytes,8,opt,name=logs_bdiadem,json=logsBdiadem,proto3" json:"logs_bdiadem,omitempty"`
...
func (m *EvmTxReceipt) GetLogsBdiadem() []byte {
	if m != nil {
		return m.LogsBdiadem
	}
	return nil
}
...
type EthBlockInfo struct {
	...
	LogsBdiadem            []byte   `protobuf:"bytes,6,opt,name=logs_bdiadem,json=logsBdiadem,proto3" json:"logs_bdiadem,omitempty"`
...
func (m *EthBlockInfo) GetLogsBdiadem() []byte {
	if m != nil {
		return m.LogsBdiadem
	}
	return nil
...
var _Contract_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/diademnetwork/go-diadem/plugin/types/types.proto",
}
...
func init() {
	proto.RegisterFile("github.com/diademnetwork/go-diadem/plugin/types/types.proto", fileDescriptor_types_b2489dcbf0534ac3)
}
