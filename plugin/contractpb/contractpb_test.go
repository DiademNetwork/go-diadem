...
func (s *ContractContextTestSuite) SetupTest() {
	s.addr1 = diadem.MustParseAddress("chain:0xb16a379ec18d4093666f8f38b11a3071c920207d")
	s.addr2 = diadem.MustParseAddress("chain:0xfa4c7920accfd66b86f5fd0e69682a79f762d49e")
}
