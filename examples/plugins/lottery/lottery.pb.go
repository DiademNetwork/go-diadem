...
// source: github.com/diademnetwork/go-diadem/examples/plugins/lottery/lottery.proto
...
func init() {
	proto.RegisterFile("github.com/diademnetwork/go-diadem/examples/plugins/lottery/lottery.proto", fileDescriptor_lottery_b72aae2d87dd032f)
}
